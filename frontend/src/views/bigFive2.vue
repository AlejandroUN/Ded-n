...
<div >
        <label><b>No hablo mucho</b></label>
            <br>
            <br>
    ...
    <div>
         ...
         <label><b>Me interesan las personas</b></label>
         <br>
         <br>
    ...
    <div>
        ...
        <label><b>Dejo mis pertenencias por ahí</b></label>
        <br>
        <br>
    ...
    <div>
        <label><b>Soy muy relajado todo el tiempo</b></label>
        <br>
        <br>
    ...
    <div>
        ...
        <label><b>Tengo dificultad para comprender ideas abstractas</b></label>
        <br>
        <br>
