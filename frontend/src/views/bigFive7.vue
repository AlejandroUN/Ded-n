...
<div >
        <label><b>Hablo con mucha gente diferente en las fiestas</b></label>
            <br>
            <br>
    ...
    <div>
         ...
         <label><b>No estoy realmente interesado en los demás</b></label>
         <br>
         <br>
    ...
    <div>
        ...
        <br>
            ...
            <br>
            <input type="radio" id="Cuarto3" value=4 v-model="resp3">
            <label for="Cuarto3"> Moderadamente en acuerdo</label>
            <br>
            <input type="radio" id="Cinco3" value=5 v-model="resp3">
            <label for="Cinco3"> Muy de acuerdo</label>
            <br>
            <br>
    </div>
    <div>
        <label><b>Cambio demasiado mi ánimo</b></label>
        <br>
        <br>
    ...
    <div>
        ...
        <label><b>Soy rápido para entender las cosas</b></label>
        <br>
        <br>
