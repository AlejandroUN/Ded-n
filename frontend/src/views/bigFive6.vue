...
<div >
        <label><b>Tengo poco que decir</b></label>
            <br>
            <br>
    ...
    <div>
         ...
         <label><b>Tengo un corazón tierno</b></label>
         <br>
         <br>
    ...
    <div>
        ...
        <label><b>A menudo me olvido de poner las cosas en su lugar correcto</b></label>
        <br>
        <br>
    ...
    <div>
        <label><b>Me enojo fácilmente</b></label>
        <br>
        <br>
    ...
    <div>
        ...
        <label><b>No tengo buena imaginación</b></label>
        <br>
        <br>
